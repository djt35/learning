		...
		*/
		...
		<div class='row narrow'>
		                <div class='col-9 veryNarrow'>
		                    <h2 class='veryNarrow' id="pageTitle" style="text-align:left; margin:0;"><?php echo 'Quality photos, videos and learning in Endoscopy and Endoscopic Resection';?></h2>
		                    		                </div>
			...
			<div id="videoChapterData" style="display:none;"><?php ?></div>
				...
				<div class='row'>
				    ...
				    <div class='col-3 black whiteborder center' style="min-height:60vh;">
