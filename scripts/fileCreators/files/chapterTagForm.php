		        ...
		        <div class='responsiveContainer white'>
			        ...
			        <div class='row'>
		                ...
		                <div id="messageBox" class='col-3 yellow-light narrow center'>
							<p><button id="tablechapterTag" onclick="window.location.href = '<?php echo BASE_URL;?>/scripts/forms/chapterTagTable.php';">Table of chapterTag</button></p>
		...
		<script>
			...
			function fillForm (idPassed){
				...
				selectorObject.done(function (data){
				    ...
				    $("#messageBox").append("Editing chapterTag id "+idPassed);
			...
			$(document).ready(function() {
				...
				if (edit == 1){
					...
					$("#messageBox").append("New chapterTag");
