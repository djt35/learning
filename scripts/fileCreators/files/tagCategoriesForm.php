		        ...
		        <div class='responsiveContainer white'>
			        ...
			        <div class='row'>
		                ...
		                <div id="messageBox" class='col-3 yellow-light narrow center'>
							<p><button id="tabletagCategories" onclick="window.location.href = '<?php echo BASE_URL;?>/scripts/forms/tagCategoriesTable.php';">Table of tagCategories</button></p>
		...
		<script>
			...
			function fillForm (idPassed){
				...
				selectorObject.done(function (data){
				    ...
				    $("#messageBox").append("Editing tagCategories id "+idPassed);
			...
			$(document).ready(function() {
				...
				if (edit == 1){
					...
					$("#messageBox").append("New tagCategories");
