		        ...
		        <div class='responsiveContainer white'>
			        ...
			        <div class='row'>
		                ...
		                <div id="messageBox" class='col-3 yellow-light narrow center'>
							<p><button id="tablequestions" onclick="window.location.href = '<?php echo BASE_URL;?>/scripts/forms/questionsTable.php';">Table of questions</button></p>
		...
		?></p>
			        ...
			        <p>
					    ...
					    <form id="questions">
					    <?php echo $formv1->generateText('text', 'text', '', 'tooltip here');
		...
		<script>
			...
			function fillForm (idPassed){
				...
				selectorObject.done(function (data){
				    ...
				    $("#messageBox").append("Editing questions id "+idPassed);
			...
			$(document).ready(function() {
				...
				if (edit == 1){
					...
					$("#messageBox").append("New questions");
