		        ...
		        <div class='responsiveContainer white'>
			        ...
			        <div class='row'>
		                ...
		                <div id="messageBox" class='col-3 yellow-light narrow center'>
		                    <p><button id="newpagelayoutercppatient" onclick="window.location.href = '<?php echo BASE_URL;?>/scripts/forms/pagelayoutercppatientForm.php';">New pagelayoutercppatient</button></p>
		                </div>
		            </div>
