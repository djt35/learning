		        ...
		        <div class='responsiveContainer white'>
			        ...
			        <div class='row'>
		                ...
		                <div id="messageBox" class='col-3 yellow-light narrow center'>
							<p><button id="tablelearningToolSlides" onclick="window.location.href = '<?php echo BASE_URL;?>/scripts/forms/learningToolSlidesTable.php';">Table of learningToolSlides</button></p>
		...
		var siteRoot = rootFolder;
			...
			function fillForm (idPassed){
				...
				selectorObject.done(function (data){
				    ...
				    $("#messageBox").append("Editing learningToolSlides id "+idPassed);
			...
			$(document).ready(function() {
				...
				if (edit == 1){
					...
					$("#messageBox").append("New learningToolSlides");
