		        ...
		        <div class='responsiveContainer white'>
			        ...
			        <div class='row'>
		                ...
		                <div id="messageBox" class='col-3 yellow-light narrow center'>
							<p><button id="tabledjango_content_type" onclick="window.location.href = '<?php echo BASE_URL;?>/scripts/forms/django_content_typeTable.php';">Table of django_content_type</button></p>
		...
		<script>
			...
			function fillForm (idPassed){
				...
				selectorObject.done(function (data){
				    ...
				    $("#messageBox").append("Editing django_content_type id "+idPassed);
			...
			$(document).ready(function() {
				...
				if (edit == 1){
					...
					$("#messageBox").append("New django_content_type");
