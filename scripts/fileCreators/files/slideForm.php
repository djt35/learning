		        ...
		        <div class='responsiveContainer white'>
			        ...
			        <div class='row'>
		                ...
		                <div id="messageBox" class='col-3 yellow-light narrow center'>
							<p><button id="tableslide" onclick="window.location.href = '<?php echo BASE_URL;?>/scripts/forms/slideTable.php';">Table of slide</button></p>
		...
		<script>
			...
			function fillForm (idPassed){
				...
				selectorObject.done(function (data){
				    ...
				    $("#messageBox").append("Editing slide id "+idPassed);
