		        ...
		        <div class='responsiveContainer white'>
			        ...
			        <div class='row'>
		                ...
		                <div id="messageBox" class='col-3 yellow-light narrow center'>
							<p><button id="tableusers_customuser_user_permissions" onclick="window.location.href = '<?php echo BASE_URL;?>/scripts/forms/users_customuser_user_permissionsTable.php';">Table of users_customuser_user_permissions</button></p>
		...
		<script>
			...
			function fillForm (idPassed){
				...
				selectorObject.done(function (data){
				    ...
				    $("#messageBox").append("Editing users_customuser_user_permissions id "+idPassed);
			...
			$(document).ready(function() {
				...
				if (edit == 1){
					...
					$("#messageBox").append("New users_customuser_user_permissions");
