		        ...
		        <div class='responsiveContainer white'>
			        ...
			        <div class='row'>
		                ...
		                <div id="messageBox" class='col-3 yellow-light narrow center'>
							<p><button id="tablelearningToolTag" onclick="window.location.href = '<?php echo BASE_URL;?>/scripts/forms/learningToolTagTable.php';">Table of learningToolTag</button></p>
		...
		var siteRoot = rootFolder;
			...
			function fillForm (idPassed){
				...
				selectorObject.done(function (data){
				    ...
				    $("#messageBox").append("Editing learningToolTag id "+idPassed);
			...
			$(document).ready(function() {
				...
				if (edit == 1){
					...
					$("#messageBox").append("New learningToolTag");
