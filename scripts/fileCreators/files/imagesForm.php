		        ...
		        <div class='responsiveContainer white'>
			        ...
			        <div class='row'>
		                ...
		                <div id="messageBox" class='col-3 yellow-light narrow center'>
							<p><button id="tableimages" onclick="window.location.href = '<?php echo BASE_URL;?>/scripts/forms/imagesTable.php';">Table of images</button></p>
		...
		var siteRoot = rootFolder;
			...
			function fillForm (idPassed){
				...
				selectorObject.done(function (data){
				    ...
				    $("#messageBox").append("Editing images id "+idPassed);
