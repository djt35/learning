		        ...
		        <div class='responsiveContainer white'>
			        ...
			        <div class='row'>
		                ...
		                <div id="messageBox" class='col-3 yellow-light narrow center'>
							<p><button id="tableauth_group_permissions" onclick="window.location.href = '<?php echo BASE_URL;?>/scripts/forms/auth_group_permissionsTable.php';">Table of auth_group_permissions</button></p>
		...
		?></p>
			        ...
			        <p>
					    ...
					    <?php echo $formv1->generateText('group_id', 'group_id', '', 'tooltip here');
		...
		<script>
			...
			function fillForm (idPassed){
				...
				selectorObject.done(function (data){
				    ...
				    $("#messageBox").append("Editing auth_group_permissions id "+idPassed);
			...
			$(document).ready(function() {
				...
				if (edit == 1){
					...
					$("#messageBox").append("New auth_group_permissions");
