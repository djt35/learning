		        ...
		        <div class='responsiveContainer white'>
			        ...
			        <div class='row'>
		                ...
		                <div id="messageBox" class='col-3 yellow-light narrow center'>
		                    <p><button id="newquestions" onclick="window.location.href = '<?php echo $roothttp;?>/scripts/forms/questionsForm.php';">New questions</button></p>
		                </div>
		            </div>
			        ...
			        <div class='row'>
		                ...
		                <div class='col-10 narrow' style='overflow-x: scroll;'>
		                    <p><?php $general->makeTable("SELECT id from questions"); ?></p>
		                </div>
