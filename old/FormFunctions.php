<?php 
        ...
        function generateSelect($stext, $sname, $svalue1, $svalue2, $post) {
       ...
       function generateChecked($stext, $sname, $svalue1, $svalue2, $post) {
            $dbc = @mysqli_connect (DB_HOST, DB_USER, DB_PASSWORD, DB_NAME);
            $query = "SELECT `".$svalue1."`, `".$svalue2."` FROM `values` WHERE `".$svalue1."` IS NOT NULL";
            $res = mysqli_query ($dbc, $query);
       ...
       function generateText($stext, $sname, $stype, $post) {
        ...
        function generateTextArea($stext, $sname, $post) {
